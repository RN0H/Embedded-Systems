...
uint8_t MainBuffer[MainBufferSize] = {0U};
uint8_t RxBuffer[RxBufferSize]     = {0U};
uint16_t FrameBuffer[24]           = {0U};
static volatile uint16_t pixel = 0U;
uint32_t xz = {0};
...
//    lcdIli9341_drawRect(10, 10, 40, 40, LCD_ILI9342_COLOR_GREEN);
  /* USER CODE END 2 */
  ...
  while (1)
  {
//	  HAL_SRAM_Read_DMA(&hsram1, p_lcdData, xz, sizeof(xz));
//	  HAL_Delay(100);
